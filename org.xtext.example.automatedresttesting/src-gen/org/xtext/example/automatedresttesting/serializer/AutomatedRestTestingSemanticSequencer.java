...
public class AutomatedRestTestingSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	protected void sequence_Assertion(ISerializationContext context, Assertion semanticObject) {
		...
		feeder.accept(grammarAccess.getAssertionAccess().getDataToTestElementEStringParserRuleCall_3_0_1(), semanticObject.getDataToTest());
		feeder.accept(grammarAccess.getAssertionAccess().getConditionExpressionParserRuleCall_5_0(), semanticObject.getCondition());
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     (type=AttributeType? expectedValue=EString? relationalOperator=RelationalOperator?)
	 */
	 ...
	 *
	 * Constraint:
	 *     (name=EString description=EString? assertions+=Assertion assertions+=Assertion*)
	 */
