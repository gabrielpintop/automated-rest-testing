...
public class AutomatedRestTestingParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AutomatedRestTestingGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getTestAccess().getAssertionsAssignment_10_0(), "rule__Test__AssertionsAssignment_10_0");
			...
			builder.put(grammarAccess.getAssertionAccess().getDataToTestAssignment_2(), "rule__Assertion__DataToTestAssignment_2");
			builder.put(grammarAccess.getAssertionAccess().getConditionAssignment_3(), "rule__Assertion__ConditionAssignment_3");
			...
			builder.put(grammarAccess.getExpressionAccess().getExpectedValueAssignment_1(), "rule__Expression__ExpectedValueAssignment_1");
