...
public class AutomatedRestTestingParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AutomatedRestTestingGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getURLExpressionAccess().getAlternatives(), "rule__URLExpression__Alternatives");
			...
			builder.put(grammarAccess.getSeparatorTypeAccess().getAlternatives(), "rule__SeparatorType__Alternatives");
			...
			builder.put(grammarAccess.getRestServiceAccess().getGroup_7_5(), "rule__RestService__Group_7_5__0");
			builder.put(grammarAccess.getRestServiceAccess().getGroup_13(), "rule__RestService__Group_13__0");
			builder.put(grammarAccess.getURLAccess().getGroup(), "rule__URL__Group__0");
			builder.put(grammarAccess.getParameterAccess().getGroup(), "rule__Parameter__Group__0");
			builder.put(grammarAccess.getSeparatorAccess().getGroup(), "rule__Separator__Group__0");
			...
			builder.put(grammarAccess.getRestServiceAccess().getRequestAssignment_7_4(), "rule__RestService__RequestAssignment_7_4");
			builder.put(grammarAccess.getRestServiceAccess().getResponseAssignment_12(), "rule__RestService__ResponseAssignment_12");
			builder.put(grammarAccess.getURLAccess().getUrlexpressionAssignment_0(), "rule__URL__UrlexpressionAssignment_0");
			builder.put(grammarAccess.getURLAccess().getUrlexpressionAssignment_1(), "rule__URL__UrlexpressionAssignment_1");
			...
			builder.put(grammarAccess.getSeparatorAccess().getSeparatorTypeAssignment_1(), "rule__Separator__SeparatorTypeAssignment_1");
			builder.put(grammarAccess.getURLTextAccess().getTextAssignment(), "rule__URLText__TextAssignment");
