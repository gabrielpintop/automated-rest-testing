...
public class DomainAttributeImpl extends AttributeImpl implements DomainAttribute {
	...
	protected EClass eStaticClass() {
		return AutomatedresttestingPackage.Literals.DOMAIN_ATTRIBUTE;
	}
	...
	public void setPrimaryKey(boolean newPrimaryKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AutomatedresttestingPackage.DOMAIN_ATTRIBUTE__PRIMARY_KEY, oldPrimaryKey, primaryKey));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AutomatedresttestingPackage.DOMAIN_ATTRIBUTE__PRIMARY_KEY:
				return isPrimaryKey();
		}
