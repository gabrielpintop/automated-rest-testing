...
public class AttributeImpl extends ElementImpl implements Attribute {
	...
	protected EClass eStaticClass() {
		return AutomatedresttestingPackage.Literals.ATTRIBUTE;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AutomatedresttestingPackage.ATTRIBUTE__VALUE, oldValue, value));
	}
	...
	public void setType(AttributeType newType) {
		...
		typeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AutomatedresttestingPackage.ATTRIBUTE__TYPE, oldType, type, !oldTypeESet));
	}
	...
	public void unsetType() {
		...
		typeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AutomatedresttestingPackage.ATTRIBUTE__TYPE, oldType, TYPE_EDEFAULT, oldTypeESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AutomatedresttestingPackage.ATTRIBUTE__RESTRICTIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AutomatedresttestingPackage.ATTRIBUTE__VALUE:
				return getValue();
			case AutomatedresttestingPackage.ATTRIBUTE__RESTRICTIONS:
				return getRestrictions();
			case AutomatedresttestingPackage.ATTRIBUTE__TYPE:
				return getType();
		}
