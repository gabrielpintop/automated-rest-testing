...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Mock Types</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see automatedresttesting.AutomatedresttestingPackage#getMockTypes()
 * @model
 * @generated
 */
public enum MockTypes implements Enumerator {
	/**
	 * The '<em><b>First Name Type</b></em>' literal object.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #FIRST_NAME_TYPE_VALUE
	 * @generated
	 * @ordered
	 */
	 ...
	 * @ordered
	 */
	public static final int FIRST_NAME_TYPE_VALUE = 0;
	 ...
	 * @ordered
	 */
	public static final int FIRST_NAME_MALE_TYPE_VALUE = 1;
	 ...
	 * @ordered
	 */
	public static final int FIRST_NAME_FEMALE_TYPE_VALUE = 2;
	 ...
	 * @ordered
	 */
	public static final int FULL_NAME_TYPE_VALUE = 5;
	 ...
	 * @ordered
	 */
	public static final int GENDER_TYPE_VALUE = 6;
	 ...
	 * @ordered
	 */
	public static final int EMAIL_ADDRESS_TYPE_VALUE = 7;
	 ...
	 * @ordered
	 */
	public static final int PHONE_TYPE_VALUE = 8;
	 ...
	 * @ordered
	 */
	public static final int COUNTRY_TYPE_VALUE = 9;
	 ...
	 * @ordered
	 */
	public static final int COUNTRY_CODE_TYPE_VALUE = 10;
	 ...
	 * @ordered
	 */
	public static final int CITY_TYPE_VALUE = 11;
	 ...
	 * @ordered
	 */
	public static final int ROW_NUMBER_TYPE_VALUE = 12;

	/**
	 * An array of all the '<em><b>Mock Types</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final MockTypes[] VALUES_ARRAY =
		new MockTypes[] {
			FIRST_NAME_TYPE,
	...
	/**
	 * A public read-only list of all the '<em><b>Mock Types</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<MockTypes> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
	...
	public static MockTypes get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			MockTypes result = VALUES_ARRAY[i];
	...
	public static MockTypes get(int value) {
		switch (value) {
			case FIRST_NAME_TYPE_VALUE: return FIRST_NAME_TYPE;
			...
			case PHONE_TYPE_VALUE: return PHONE_TYPE;
			case COUNTRY_TYPE_VALUE: return COUNTRY_TYPE;
	 ...
	 * @generated
	 */
	private MockTypes(int value, String name, String literal) {
		this.value = value;
		this.name = name;
